...
public final class ModpackInstaller {
	...
	public static void createZip(Path path, Path zipLocation, FileType type)
			throws CurseException, IOException, ZipException {
		createZip(path, zipLocation, type, "cfg", "json", "txt");
	}
	...
	public static void createZip(Path path, Path zipLocation, FileType type,
		...
		NIOUtils.write(newManifest, modpack.toPrettyJsonWithTabs());
